...
const useCases = [
  {
    ...
    text:
      "Pre dospelých aj pre deti — namiesto bežnej oslavy si zatvoríme spolu.",
    accent: "rose"
  },
  {
    emoji: "👰",
    ...
    text:
      "Pripravím vám tvorivý zážitok s prosecom a kávou — výtvor si odnesiete domov.",
    accent: "azure"
  },
  {
    emoji: "🤝",
    ...
    text:
      "Veľký pôsobivý zážitok pre tím — z workshopu odídete inšpirovaní a oddýchnutí.",
    accent: "rose"
  },
  {
    emoji: "👶",
...
export default function PrivateEventsPage() {
  return (
    <>
      <section className="relative overflow-hidden bg-rose-light/60">
        ...
        <Container large className="relative !py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="mt-2 text-4xl font-bold md:text-5xl">
              ...
              <span className="font-display text-rose-dark">vašu skupinu</span>
            </h1>
            <Squiggle className="mx-auto mt-5 w-32 text-azure" />
            <p className="mx-auto mt-5 max-w-xl text-lg text-ink-soft">
              Hľadáte zážitok, ktorý spojí vašu skupinu? Vyberieme spolu
              techniku, ladenie aj výsledný výtvor. Pripravím všetko — vy
              len prídete a tvoríte.
            </p>
            <div className="mt-7">
      ...
      <Container large className="relative !py-16">
        <div className="grid gap-6 md:grid-cols-2">
          {useCases.map(uc => (
            <div
              ...
              <h3 className="mt-3 text-2xl font-bold">{uc.title}</h3>
        ...
        <div className="relative overflow-hidden rounded-[2.5rem] bg-ink p-10 text-paper-50 md:p-14">
          ...
          <ol className="relative mt-6 grid gap-6 md:grid-cols-3">
            {[
              ...
              {
                step: "2",
                title: "Pripravíme detail",
                text:
                  "Vyberieme spolu techniku, miesto a cenu. Pošlem zálohu na potvrdenie.",
                icon: Heart,
              ...
              },
              {
                ...
                title: "Tvoríme",
                text:
                  "Prídete s úsmevom, ja sa postarám o zvyšok. Odídete s hotovým výtvorom.",
                icon: Sparkle,
                color: "text-rose-soft"
              }
            ].map(item => {
              ...
              return (
                <li key={item.step}>
                  <div className="flex items-center gap-2">
                    <span className={`font-display text-3xl ${item.color}`}>
                      {item.step}.
                    </span>
                  ...
                  <p className="mt-1 text-sm text-paper-100/80">
                    {item.text}
                  </p>
                </li>
              );
